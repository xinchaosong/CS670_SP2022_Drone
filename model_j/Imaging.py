...
class FrameManager:
    ...
    """
    def __init__(self, dataSubSubFolder, rootFolder, dataSubFolder, resultsSubFolder, fileRegEx="[0-9_]+[.]jpg", COLOR="RGB"):
        self.COLOR = COLOR
        self.rootFolder = rootFolder
        self.dataSubFolder = dataSubFolder
        self.resultsSubFolder = resultsSubFolder
        self.subPath = r"%s" % (dataSubSubFolder)
        if dataSubSubFolder == "":
            ...
            self.imageSetName = dataSubSubFolder
    ...
    def setNextFrame(self):
        if self.imagesOnStack > 0:
            ...
            self.currentImage = CustomImage(self.currentImageName, join(self.fullPathToSource,self.currentImageName), self.COLOR)
